...
bool Maching( vector<string>& Sized, int col, char ch) {
...
bool Vika( vector<string>& Sized) {
    for (int vCol = 0; vCol < Sized[0].size(); ++vCol) {
        if (Maching(Sized, vCol, 'v')) {
            for (int iCol = vCol + 1; iCol < Sized[0].size(); ++iCol) {
                if (Maching(Sized, iCol, 'i')) {
                    for (int kCol = iCol + 1; kCol < Sized[0].size(); ++kCol) {
                        if (Maching(Sized, kCol, 'k')) {
                            for (int aCol = kCol + 1; aCol < Sized[0].size(); ++aCol) {
                                if (Maching(Sized, aCol, 'a')) {
                                    return true;
                                }
                            }
                        }
